...
def get_crop_config(crop_name: str, year_str: str) -> dict:
    ...
    configs = {
        ...
        "cotton": {
            ...
            "static_window_end": "",
            "composite_step_days": 8,
            # v1, the binary model. v2 scored better on sampled curves but the Layyah
            # district map it produced was judged worse than v1's by eye, and a map that
            # looks wrong is wrong whatever the sampled metrics say. v2 stays on disk at
            # timeseries_model/model_v2/ pending a proper look at why the two disagree.
